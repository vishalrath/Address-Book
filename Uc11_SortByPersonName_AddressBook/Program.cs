...
namespace Uc11_SortByPersonName_AddressBook
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (numberBook < numAddBook)                                //this while loop runs till the favourable no. of add books are created
            {
                ...
                while (keyPress != "n")
                {
                    Console.WriteLine("1- Add contact, 2- View all contacts, 3- Edit contact, 4- Delete contact,5-SearchName  ,6-SearchCity,7-ViewByCity, 8-CountByCity 9-SearchState, 10-ViewByState,11-CountByState");
